...
inline WheelContactKinematics wheelContactKinematics(double forward_m_s, double lateral_m_s,
                                                     double yaw_rad_s, double x_m, double y_m,
                                                     double rolling_speed_m_s) {
